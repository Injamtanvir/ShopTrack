...
ROOT_URLCONF = 'shoptrack_backend.urls'
...
WSGI_APPLICATION = 'shoptrack_backend.wsgi.application'


# Database
# https://docs.djangoproject.com/en/4.2/ref/settings/#databases

# We'll use MongoDB directly with PyMongo instead of through Django ORM
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.sqlite3',
        'NAME': BASE_DIR / 'db.sqlite3',  # This is just for Django's internal use
    }
}
...
# Email settings
EMAIL_PASSWORD = config('EMAIL_PASSWORD', default='shoptrack_password')
EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
EMAIL_HOST = 'smtp.gmail.com'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'shoptrack.gnvox@gmail.com'