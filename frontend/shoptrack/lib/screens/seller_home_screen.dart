...
class SellerHomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Debug print to check seller details
    print('SellerHomeScreen - Building screen for user:');
    ...
    // Format the designation and seller ID for display
    final String displayDesignation = user.designation ?? 'Not Assigned';
    final String displaySellerId = user.sellerId ?? 'Not Assigned';

    return Scaffold(
      appBar: AppBar(
        title: Text('${user.shopName ?? "Shop"} Dashboard'),
        backgroundColor: Colors.indigo,
        actions: [
          IconButton(
            icon: const Icon(Icons.logout),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 8),
                      Text(
                        'Shop: ${user.shopName ?? user.shopId}',
                        style: const TextStyle(
                          fontSize: 16,
                          color: Colors.black54,
                        ),
