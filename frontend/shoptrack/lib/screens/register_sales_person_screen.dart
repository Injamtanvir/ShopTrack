...
//     // final bool canRegisterSalesPerson = user?.role == 'admin' || user?.role == 'owner';
//     //
//     // if (!canRegisterSalesPerson) {
//
//     final canRegisterSalesPerson = user?.role == 'admin' || user?.role == 'owner';
//
//     if (!canRegisterSalesPerson) {
//       return Scaffold(
//         appBar: AppBar(
...
//                   //   ),
//                   //   child: const Text(
//                   //     'Only admins and owners can register sales persons',
